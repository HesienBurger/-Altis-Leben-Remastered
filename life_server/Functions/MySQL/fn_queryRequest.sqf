...
_query = switch(_side) do {
	...
	case civilian: {_returnCount = 9; format["SELECT playerid, name, cash, bankacc, adminlevel, donatorlvl, civ_licenses, arrested, civ_gear, lawyerlevel FROM players WHERE playerid='%1'",_uid];};
